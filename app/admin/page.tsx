      ...
      <header className="bg-white border-b shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={loadQuadras}
              className="flex items-center gap-2 text-sm text-gray-600 hover:text-gray-800 border border-gray-300 rounded-lg px-3 py-2 hover:bg-gray-50 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm text-gray-500 hover:text-red-600 border border-gray-300 rounded-lg px-3 py-2 hover:bg-gray-50 transition-colors"
              title="Sair do admin"
            >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-xl p-5 border border-gray-200">
            <p className="text-sm text-gray-500">Total de Quadras</p>
            <p className="text-3xl font-bold text-gray-800 mt-1">{loading ? '—' : quadras.length}</p>
          </div>
          <div className="bg-white rounded-xl p-5 border border-gray-200">
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-200">
            <p className="text-sm text-gray-500">Preço Médio/hora</p>
            <p className="text-3xl font-bold text-gray-800 mt-1">
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            {quadras.length === 0 ? (
              <div className="text-center py-20">
                <p className="text-gray-500 mb-4">Nenhuma quadra cadastrada ainda.</p>
                <Link
                  href="/admin/quadras/nova"
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      <th className="text-left px-6 py-3 font-semibold text-gray-600">Quadra</th>
                      <th className="text-left px-4 py-3 font-semibold text-gray-600">Localização</th>
                      <th className="text-left px-4 py-3 font-semibold text-gray-600">Tipo</th>
                      <th className="text-left px-4 py-3 font-semibold text-gray-600">Preço/hora</th>
                      <th className="text-left px-4 py-3 font-semibold text-gray-600">Avaliação</th>
                      <th className="text-right px-6 py-3 font-semibold text-gray-600">Ações</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {quadras.map((quadra) => (
                      <tr key={quadra.id} className={`hover:bg-gray-50 transition-colors ${quadra.ativo === false ? 'opacity-50' : ''}`}>
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-gray-800 line-clamp-1">{quadra.nome}</p>
                              <p className="text-xs text-gray-500 line-clamp-1">{quadra.descricao}</p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-gray-700">{quadra.avaliacao}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Link
                              ...
                              className="flex items-center gap-1.5 text-blue-600 hover:text-blue-800 border border-blue-200 hover:bg-blue-50 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 text-red-600 hover:text-red-800 border border-red-200 hover:bg-red-50 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
