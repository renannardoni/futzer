...
export const mockCourts: Court[] = [
  ...
  },
  {
    id: "3",
    nome: "Futsal Center",
    descricao: "Quadra de salão coberta com climatização",
    endereco: {
  ...
  {
    id: "6",
    nome: "Quadra Vila Madalena",
    descricao: "Quadra de salão comunitária bem mantida",
    endereco: {
  ...
  },
  {
    id: "7",
    nome: "Arena Itaim",
    descricao: "Quadra society moderna no coração do Itaim",
    endereco: {
